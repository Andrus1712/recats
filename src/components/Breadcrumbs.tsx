import { capitaliceFirstLetter } from "@/helpers";
                ...
                <div key={crumb} className="crumb">
                    {location.pathname == currentLink ?
                        <li aria-current="page" className="inline-flex items-center">
                            ...
                            <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{capitaliceFirstLetter(crumb)}</span>
                        </li>
                        :
                        <li className="inline-flex items-center">
                            <Link to={currentLink} className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                {index != 0 ?
